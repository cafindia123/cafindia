                        ...
                        <div class="panel-body">
                            ...
                            <ul class="permissions checkbox">
                                ...
                                @foreach(Voyager::model('Permission')->all()->groupBy('table_name') as $table => $permission)
                                    ...
                                    @if(in_array($table,unserialize(ONLY_MENU_SHOW_DEVELOPER)) && Auth::user()->role_id != ROLE_ID_DEVELOPER)
                                      @php  continue; @endphp
                                    @endif
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            @foreach($permission as $perm)
                                                @if(in_array($perm->key,unserialize(TOOLS_MENU_SHOW)) && Auth::user()->role_id != ROLE_ID_DEVELOPER)
                                                    @php  continue; @endphp
                                                @endif  
                                                <li>
